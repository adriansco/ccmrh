...
@section('page-title', 'Lista exámenes')

@section('content')
    <div class="mb-2 text-right">
        <a href="{{ route('exams.create') }}" class="btn btn-space btn-primary"><i
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-table">
                <div class="card-header">Exámenes
                    {{-- <span class="text-right text-span"></span> --}}
                    <div class="tools">
                        <a href="{{ route('exams.pdf') }}" title="Descargar PDF"><span
                                class="icon lar la-file-pdf"></span></a>
                        <a href="{{ route('exams.excel') }}" title="Descargar EXCEL"><span
                                        ...
                                        <div class="centrar">
                                            <form action="{{ route('exams.destroy', $exam) }}" method="POST">
                                                ...
                                                <a class="btn btn-sm btn-rounded btn-primary "
                                                    href="{{ route('exams.edit', $exam) }}">Editar</a>
                                                <button
