...
@section('breadcrumbs')
    <div class="page-head">
        <h2 class="page-head-title">Modificar departamento</h2>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-border-color card-border-color-primary">
                <div class="card-header card-header-divider">Datos del departamento
                    {{ $department->name }}<span class="card-subtitle">Los campos
                    ...
                    <form action="{{ route('departments.update', $department) }}" method="POST">
                        ...
                        <div class="form-group pt-2">
                            ...
                            <input class="form-control" id="name" name="name" type="text"
                                placeholder="Ingresar nombre" value="{{ old('name', $department->name) }}">
                            @error('name')
                                *{{ $message }}
                            @enderror
                        </div>
