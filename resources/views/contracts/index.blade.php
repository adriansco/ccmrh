...
@section('content')
    ...
    <div class="mb-2 text-right">
        <a href="{{ route('contracts.create') }}" class="btn btn-space btn-primary"><i
                class="icon icon-left las la-user-plus"></i>Agregar</a>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-table">
                <div class="card-header">Seguimiento de contratos
                    {{-- <span class="text-right text-span"></span> --}}
                    {{-- <div class="tools">
                        <a href="{{ route('contracts.pdf') }}" title="Descargar PDF"><span
                                class="icon lar la-file-pdf"></span></a>
                        <a href="{{ route('contracts.excel') }}" title="Descargar EXCEL"><span
                                class="icon lar la-file-excel"></span></a>
                    </div> --}}
                </div>
                <div class="card-body">
                    {{-- <table class="table table-striped table-hover table-fw-widget" id="table4" style="width: 100%"> --}}
                    <table id="example" class="display table table-striped table-hover table-fw-widget" style="width:100%">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Position</th>
