                                ...
                                <div class="content">
                                    ...
                                    <div class="contact-list contact-list-recent">
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('img/avatar1.png') }}" alt="Avatar">
                                        ...
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('img/avatar2.png') }}" alt="Avatar">
                                        ...
                                        <div class="user"><a href="#"><img
                                                    src="{{ asset('img/avatar3.png') }}" alt="Avatar">
