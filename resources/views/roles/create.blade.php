...
@section('breadcrumbs')
    <div class="page-head">
        <h2 class="page-head-title">Agregar rol</h2>
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                <li class="breadcrumb-item"><a href="{{ route('roles.index') }}">Razones</a></li>
                        ...
                        <div class="row pt-3">
                            <div class="col-lg-12 col-lg-6 pb-4 pb-lg-0">
                                <p class="text-right">
                                    ...
                                    <a href="{{ route('roles.index') }}" class="btn btn-space btn-secondary">Cancel</a>
                                </p>
                            </div>
                        </div>
                    </form>
