...
var App = (function () {
    ...
    function leftSidebarInit() {
        ...
        var openLeftSidebarOnClick = config.openLeftSidebarOnClick
            ? true
            : false;
        ...
        function toggleSideBar() {
            ...
            button.on("click", function () {
                if (wrapper.hasClass(config.collapsibleSidebarCollapsedClass)) {
                    wrapper.removeClass(
                        config.collapsibleSidebarCollapsedClass
                    );
                    $("li.open", leftSidebar).removeClass("open");
                    $("li.active", leftSidebar)
                        .parents(".parent")
                    ...
                    if (
                        ...
                        ps_be_scroller_left_sidebar = initScroller(
                            $(".be-scroller", leftSidebar)
                        );
                    }
        ...
        function tooltipSidebar() {
            ...
            menu.on("mouseenter", function () {
                if (
                    !$.isSm() &&
                    wrapper.hasClass(config.collapsibleSidebarCollapsedClass)
                ) {
                    $(this).tooltip("show");
                }
            });
        ...
        function openSubMenu(anchor, event) {
            ...
            var slideSpeed = config.leftSidebarSlideSpeed;
            var isFirstLevel = $(event.currentTarget)
                .parents()
                .eq(1)
                .hasClass("sidebar-elements");
            ...
            if (!$.isSm() && isCollapsed() && isFirstLevel) {
                ...
                if (
                    ...
                    ps_sub_menu_scroller = initScroller(
                        li.find(".be-scroller")
                    );
                }
        ...
        if (
            topNavbar.find(".container-fluid > .navbar-collapse").length &&
            leftSidebar.length
        ) {
            wrapper
        ...
        if (wrapper.hasClass("be-fixed-sidebar")) {
            if (
                !$.isSm() ||
                wrapper.hasClass(config.offCanvasLeftSidebarClass)
            ) {
                if (
    ...
    function rightSidebarInit() {
        ...
        function oSidebar() {
            body.addClass(
                config.openRightSidebarClass + " " + config.transitionClass
            );
            openSidebar = true;
        }

        function cSidebar() {
            body.removeClass(config.openRightSidebarClass).addClass(
                config.transitionClass
            );
            sidebarDelay();
        }
        ...
        if (
            (typeof ps_chat_scroll === "undefined" ||
                !ps_chat_scroll ||
                !ps_chat_scroll.nodeName) &&
        ...
        if (
            (typeof ps_todo_scroll === "undefined" ||
                !ps_todo_scroll ||
                !ps_todo_scroll.nodeName) &&
        ...
        $('a[data-toggle="tab"]', rightSidebar).on(
            "shown.bs.tab",
            function (e) {
                updateScroller(ps_chat_scroll);
                updateScroller(ps_todo_scroll);
    ...
    return {
        ...
        init: function (options) {
            ...
            if (
                ...
                wrapper.hasClass("be-boxed-layout")
            ) {
                var observer = new MutationObserver(function (
                    ...
                    mutationsList.forEach(function (mutation) {
                        if (
                            ...
                            if (
                                document.body.className.indexOf("swal2-shown") >
                                0
                            ) {
                                topNavbar.css({
                                    marginLeft:
...
(FastClick.prototype.needsClick = function (e) {
    ...
    (FastClick.prototype.onTouchEnd = function (e) {
        ...
        return (
            ...
            (this.needsClick(s) || (e.preventDefault(), this.sendClick(s, e)),
            !1)
        );
    }),
    ...
    (b.prototype = {
        ...
        getLuminance: function () {
            ...
            return (
                ...
                (d = h.b / 255),
                (e =
                    0.03928 >= b ? b / 12.92 : a.pow((b + 0.055) / 1.055, 2.4)),
                (f =
                    0.03928 >= c ? c / 12.92 : a.pow((c + 0.055) / 1.055, 2.4)),
                (g =
                    0.03928 >= d ? d / 12.92 : a.pow((d + 0.055) / 1.055, 2.4)),
                0.2126 * e + 0.7152 * f + 0.0722 * g
            );
        },
        setAlpha: function (a) {
            return (
                (this._a = z(a)), (this._roundA = P(100 * this._a) / 100), this
            );
        },
        toHsv: function () {
...
!(function (r) {
    var i = function (n) {
        var e, i;
        return (
            (i = (e = r("<div/>", { class: n }).appendTo("body")).is(
                ":visible"
            )),
            e.remove(),
            i
